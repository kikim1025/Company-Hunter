                                ...
                                ?   <section className='modal grid grid--modal'>
                                        <div className='modal__name item-row'>
                                            <div className='input-group'>
                                                ...
                                                <input type='text' name='name' maxLength='30' placeholder='Company Name' 
                                                    defaultValue={this.props.name} onChange={this.getInput}
                                                />
                                            </div>
                                        </div>
                                        ...
                                        <div className='modal__buttons item-row'>
                                            <Button name='Send Data' style='btn-success' />
                                        </div>
                                    </section>
                                :   <section className='modal grid grid--modal'>
                                        ...
                                        <div className='modal__buttons item-row'>
                                            <div className='left'><Button name='Delete' style='btn-danger' 
                                                onClick={() => this.props.deleteCompany(this.props.name)}
                                            /></div>
                                            <div className='right'><Button name='Edit' style='btn-primary'
                                                onClick={this.getUpdateScreen}
                                            /></div>
                                        </div>
                                    </section>
                            }
